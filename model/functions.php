...
function getcontrefer($tmpid2,$postArrIndex2){//retrieve references for titles and contents
			$id2 = "";
			$recon = new recordUpdate();	
			$arrVal = array('id','name');
			$retArray21 = $recon->retrieveEntry("reference", $arrVal, "", "ref_id='$tmpid2' AND ref_name='template_style' AND name='$postArrIndex2' ");
		foreach ($retArray21 as $retIndex => $retValue){
				$$retIndex = $retValue;
