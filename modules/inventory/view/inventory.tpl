...
<div class="idTabs">
  <ul>
    <li><a href="#clientinfo" tabindex="-1">Inventory Information</a></li>
  </ul>
<div class="items">
			...
			<table width="100%" border="0" cellpadding="2" cellspacing="2">
				<tr>
					...
					<td style="width:20%">
                                                ...
                                                <?
								$retrieveItems = $recon->retrieveCustomQuery("SELECT itemId, itemName, itemCode FROM item where statusId <>-1 order by itemName");
							...
							?>
                                        ...
                                        <td style="width:10%"><?=$mform->label('quantity',"Quantity","","req")?></td>
	...
	<tr>
		<td colspan="2" class="right">
			...
			if($task!='view'){
				...
				echo $mform->inputBox($taskView,'button','edit','Adjust Inventory','flat_button','edit','',' onClick="redirect(\'index.php?mod='.$mod.'&type='.$type.'&task=edit&sid='.$sid.'\');" ','','23');
				echo '&nbsp;&nbsp;&nbsp;';
				echo $mform->inputBox($task,'button','cancel','Cancel','flat_button','cancel','',' onClick="cancelChanges(\'index.php?mod='.$mod.'&type='.$type.'\');" ','','24');
			}
