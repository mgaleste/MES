<div class="idTabs">
  <ul>
    <li><a href="#clientinfo" tabindex="-1">Location Information</a></li>
  </ul>
<div class="items">
...
<tr valign="top" >
		<td style="width:95%; height:100%;" >
			<table width="100%" border="0" cellpadding="2" cellspacing="2">
				<tr>
					<td style="width:10%"><?=$mform->label('locationName',"Location Name","","req")?></td>
					<td style="width:20%"><?=$mform->inputBox($task,'text','locationName',$locationName,'flat_input','locationName','50','','','1');?></td>
                                        <td style="width:10%"><?=$mform->label('locationCode',"Location Code","","req")?></td>
					<td style="width:20%"><?=$mform->inputBox($task,'text','locationCode',$locationCode,'flat_input','locationCode','50','','','1');?></td>
