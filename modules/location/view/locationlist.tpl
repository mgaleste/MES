			...
			<table width="100%" cellpadding="0" cellspacing="0" id="myTable" class="tablesorter">					
				<thead>		
					...
					<tr valign="middle">
						...
						<th width="20%" class="table_line1_left">Location Name</th>
						<th width="20%" class="table_line1_left">Location Code</th>
					</tr>
					<tr valign="middle"><th class="bar" colspan="3"></th></tr>
				</thead>
			...
			<?php
				...
				if($num_rows>0){
					...
					for($i=0;$i<$num_rows;$i++){
						...
						$locationId 				= mysql_result($result, $i, "locationId");
						$locationName		 	= mysql_result($result, $i, "locationName");
						$locationCode		 	= mysql_result($result, $i, "locationCode");
						...
						$link				= "index.php?mod=$mod&type=$type&task=view&sid=$ids";
							...
							echo '	<td align="center" class="table_line2_"><input class="ibox" value="'.$ids.'" name="delAnn[]" onclick="checkAllFields(2);" type="checkbox"></td>
									<td class="table_line2_left" id="'.$link.'" onClick="viewRecord(event,this.id);">'.$locationName.'&nbsp;</td>
                                                                        <td class="table_line2_left_right">'.stripslashes(html_entity_decode($locationCode)).'&nbsp;</td>';
